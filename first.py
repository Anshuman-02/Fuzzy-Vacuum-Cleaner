...
# Fuzzy rules
rule1 = ctrl.Rule(dirtiness['poor'] & distance_from_Surface['poor'], speed['slow'])  # Corrected variable name here
rule2 = ctrl.Rule(dirtiness['average'] & distance_from_Surface['average'], speed['medium'])  # Corrected variable name here
rule3 = ctrl.Rule(dirtiness['good'] & distance_from_Surface['good'], speed['fast'])  # Corrected variable name here
